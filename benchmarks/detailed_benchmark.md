...
**M2 (4E+4P+10GPU+24GB) - mlx: 0.16.0 torch: 2.4.0**

| Operation                                           | mlx_gpu | mlx_gpu_compile | mlx_cpu | mps | cpu | mlx_gpu_compile/mlx_gpu speedup | mlx_gpu/mps speedup | mlx_gpu/mlx_cpu speedup |
|-----------------------------------------------------|-------|---------------|-------|------|------|-------------------------------|-------------------|-----------------------|
| Argmax / dim=64x1024x128 axi=0                  |   2.04 |   1.62 |   9.62 |   3.06 |  14.88 |    +25% |    +50% |   +371% |
| Argmax / dim=64x1024x128 axi=1                  |   1.64 |   1.60 |   9.63 |   1.09 |   8.36 |     +2% |    -33% |   +486% |
| Argmax / dim=64x1024x128 axi=2                  |   1.60 |   1.59 |   9.63 |   1.85 |   3.20 |     +0% |    +15% |   +502% |
| Argmax / dim=64x128x1024 axi=2                  |   1.59 |   1.59 |   9.63 |   0.82 |   2.76 |      0% |    -48% |   +506% |
| BCE / dim=1000000 dim=1000000                   |   0.74 |   0.35 |   7.81 |   0.32 |   1.48 |   +112% |    -57% |   +960% |
| BCE / dim=100000x32 dim=100000x32               |   1.91 |   0.87 |  25.26 |   0.59 |   4.46 |   +119% |    -69% |  +1224% |
| BCE / dim=100000x64x2 dim=100000x64x2           |   6.66 |   2.53 | 102.75 |   1.48 |  19.26 |   +163% |    -77% |  +1443% |
| BCE / dim=128x100000 dim=128x100000             |   6.66 |   2.52 | 102.63 |   1.44 |  19.21 |   +164% |    -78% |  +1441% |
| Concat / dim=1000000x64 dim=1000000x32 axi=1    |   9.34 |   8.81 |  73.33 |   8.59 |  26.92 |     +5% |     -7% |   +685% |
| Concat / dim=1000000x64 dim=1000000x128 axi=1   |  16.78 |  16.79 | 141.33 |  16.84 |  57.87 |      0% |     +0% |   +742% |
| Concat / dim=1000000x64 dim=1000000x64 axi=0    |  11.28 |  11.28 |  75.29 |  11.28 |  25.59 |     +0% |      0% |   +567% |
| Concat / dim=64x1000000 dim=64x1000000 axi=0    |  11.26 |  11.26 |  77.65 |  11.49 |  26.24 |      0% |     +1% |   +589% |
| Conv1d / dim=100x256x3 dim=8x3x3                |   0.34 |   0.39 |   0.30 |   0.29 |   1.97 |    -11% |    -16% |    -11% |
| Conv1d / dim=100x256x256 dim=8x3x256            |   4.70 |   4.71 |   9.27 |   1.89 |  40.03 |      0% |    -59% |    +97% |
| Conv1d / dim=16x1000x80 dim=128x11x80           |   3.93 |   3.94 |   5.69 |   2.18 | 237.62 |      0% |    -44% |    +44% |
| Conv1d / dim=16x1000x3 dim=128x11x3             |   0.46 |   0.47 |   0.27 |   0.40 |  36.51 |     -1% |    -12% |    -42% |
| Conv2d / dim=100x256x256x3 dim=8x3x3x3          |  12.57 |  12.59 | 1198.11 |   7.91 |  76.67 |      0% |    -37% |  +9432% |
| Conv2d / dim=10x256x256x12 dim=8x3x3x12         |  25.53 |  25.61 | 473.36 |   4.75 |  29.21 |      0% |    -81% |  +1753% |
| Conv2d / dim=1x256x256x128 dim=8x3x3x128        |   1.41 |   1.42 | 668.04 |   5.63 |  29.96 |      0% |   +298% | +47148% |
| Conv2d / dim=100x28x28x3 dim=8x3x3x3            |   0.34 |   0.35 |  13.09 |   0.47 |   0.70 |     -3% |    +39% |  +3802% |
| Conv2d / dim=1000x28x28x3 dim=8x3x3x3           |   1.65 |   1.70 | 131.17 |   1.31 |   6.51 |     -2% |    -20% |  +7840% |
| Gather / dim=64x256 dim=10                      |   0.13 |   0.18 |   0.02 |   0.10 |   0.00 |    -29% |    -17% |    -83% |
| Gather / dim=64x256 dim=1000                    |   0.19 |   0.23 |   0.04 |   0.21 |   0.05 |    -17% |    +10% |    -78% |
| Gather / dim=64x256 dim=1000000                 |  23.09 |  23.08 |  18.18 | 164.47 |  53.92 |     +0% |   +612% |    -21% |
| Gather / dim=1024x32 dim=10                     |   0.17 |   0.17 |   0.02 |   0.13 |   0.00 |      0% |    -24% |    -89% |
| Gather / dim=1024x32 dim=1000                   |   0.18 |   0.17 |   0.02 |   0.13 |   0.03 |     +0% |    -26% |    -86% |
| Gather / dim=1024x32 dim=1000000                |   3.31 |   3.32 |   5.63 |  20.90 |   8.08 |      0% |   +530% |    +69% |
| LeakyReLU / dim=128x16x1024                     |   0.38 |   0.39 |   0.95 |   0.39 |   0.30 |     -1% |     +1% |   +149% |
| LeakyReLU / dim=64x128x1024                     |   1.03 |   1.04 |   1.14 |   1.04 |   1.60 |      0% |     +0% |     +9% |
| Linear / dim=100x1024x32 dim=32x1024 dim=1024   |   5.78 |   5.47 |  34.41 |  11.39 |  50.43 |     +5% |    +96% |   +495% |
| Linear / dim=100x1024x64 dim=64x1024 dim=1024   |   6.00 |   6.29 |  44.01 |  19.39 |  58.94 |     -4% |   +222% |   +632% |
| Linear / dim=100x1024x256 dim=256x1024 dim=1024 |  18.94 |  18.95 |  71.76 |  66.88 |  86.05 |      0% |   +253% |   +278% |
| Linear / dim=100x1024x512 dim=512x1024 dim=1024 |  36.49 |  36.49 | 111.28 | 131.48 | 126.11 |      0% |   +260% |   +204% |
| Linear / dim=100x1x51200 dim=51200x1 dim=1      |   0.51 |   0.51 |   0.21 |   0.46 |   0.19 |     +0% |    -10% |    -59% |
| MatMul / dim=32x1x1000 dim=32x1000x128          |   0.38 |   0.38 |   0.15 |   0.40 |   0.22 |     +0% |     +4% |    -59% |
| MatMul / dim=1000x64x256 dim=256x32             |   1.26 |   1.28 |   3.85 |  55.28 |   4.08 |     -1% |  +4301% |   +206% |
| MatMul / dim=1000x64x1024 dim=1000x1024x32      |   4.94 |   4.97 |  16.28 |  16.66 |  20.75 |      0% |   +236% |   +229% |
| MatMul / dim=1000x1024x64 dim=1000x64x256       |  16.62 |  16.67 |  40.75 |  18.79 | 117.86 |      0% |    +13% |   +145% |
| MatMul / dim=64x1000000 dim=1000000x32          |  21.47 |  23.53 |  15.02 | 364.53 |  15.26 |     -8% |  +1597% |    -30% |
| MatMul / dim=1000000x64 dim=64x1024             |  55.74 |  55.94 | 225.51 | 6784.26 | 444.26 |      0% | +12070% |   +304% |
| PReLU / dim=128x16x1024 dim=1                   |   0.38 |   0.40 |   2.12 |   0.38 |   0.32 |     -4% |     +1% |   +459% |
| PReLU / dim=64x128x1024 dim=1                   |   1.02 |   1.03 |   5.12 |   0.97 |   1.57 |     -1% |     -5% |   +402% |
| ReLU / dim=128x16x1024                          |   0.38 |   0.39 |   0.68 |   0.37 |   0.29 |     -1% |     -4% |    +78% |
| ReLU / dim=64x128x1024                          |   1.01 |   1.02 |   0.82 |   0.98 |   1.54 |      0% |     -3% |    -19% |
| Scatter / dim=64x16 dim=10                      |   0.14 |   0.15 |   0.02 |   0.11 |   0.00 |     -9% |    -21% |    -87% |
| Scatter / dim=64x16 dim=1000                    |   0.14 |   0.15 |   0.08 |   0.12 |   0.02 |     -4% |    -12% |    -41% |
| Scatter / dim=64x16 dim=1000000                 |   1.49 |   1.50 |  58.54 |  10.42 |   3.44 |      0% |   +600% |  +3832% |
| Scatter / dim=1024x32 dim=10                    |   0.16 |   0.16 |   0.02 |   0.14 |   0.00 |     +2% |    -13% |    -86% |
| Scatter / dim=1024x32 dim=1000                  |   0.17 |   0.17 |   0.14 |   0.14 |   0.02 |     +2% |    -19% |    -19% |
| Scatter / dim=1024x32 dim=1000000               |   2.70 |   2.71 | 110.26 |  20.68 |   5.32 |      0% |   +666% |  +3985% |
| ScatterSum / dim=64x16 dim=10                   |   0.03 |   0.03 |   0.02 |    nan |   0.00 |     +2% |    nan% |    -44% |
| ScatterSum / dim=64x16 dim=1000                 |   0.03 |   0.03 |   0.02 |    nan |   0.00 |     -1% |    nan% |    -42% |
| ScatterSum / dim=64x16 dim=1000000              |   0.03 |   0.03 |   0.02 |    nan |   1.49 |      0% |    nan% |    -42% |
| ScatterSum / dim=1024x32 dim=10                 |   0.03 |   0.03 |   0.02 |    nan |   0.01 |     +0% |    nan% |    -41% |
| ScatterSum / dim=1024x32 dim=1000               |   0.03 |   0.03 |   0.02 |    nan |   0.01 |      0% |    nan% |    -45% |
| ScatterSum / dim=1024x32 dim=1000000            |   0.03 |   0.03 |   0.02 |    nan |   6.48 |     +2% |    nan% |    -44% |
| ScatterMax / dim=64x16 dim=10                   |   0.03 |   0.03 |   0.02 |    nan |   0.00 |     +1% |    nan% |    -40% |
| ScatterMax / dim=64x16 dim=1000                 |   0.03 |   0.03 |   0.02 |    nan |   0.00 |     +0% |    nan% |    -42% |
| ScatterMax / dim=64x16 dim=1000000              |   0.03 |   0.03 |   0.02 |    nan |   1.49 |      0% |    nan% |    -41% |
| ScatterMax / dim=1024x32 dim=10                 |   0.03 |   0.03 |   0.02 |    nan |   0.01 |     +1% |    nan% |    -43% |
| ScatterMax / dim=1024x32 dim=1000               |   0.03 |   0.03 |   0.02 |    nan |   0.01 |     +1% |    nan% |    -43% |
| ScatterMax / dim=1024x32 dim=1000000            |   0.03 |   0.03 |   0.02 |    nan |   6.49 |     +2% |    nan% |    -43% |
| SeLU / dim=128x16x1024                          |   0.39 |   0.40 |   2.54 |   0.38 |   1.41 |     -1% |     -2% |   +545% |
| SeLU / dim=64x128x1024                          |   1.03 |   1.03 |   7.32 |   1.03 |   5.60 |     +0% |     +0% |   +608% |
| Sigmoid / dim=128x16x1024                       |   0.38 |   0.39 |   1.74 |   0.38 |   1.14 |     -1% |     +0% |   +356% |
| Sigmoid / dim=64x128x1024                       |   1.00 |   1.01 |   6.92 |   1.03 |   4.56 |      0% |     +3% |   +590% |
| Softmax / dim=64x1000000 axi=-1                 |  22.37 |  16.44 |  51.77 |  11.61 |  30.50 |    +36% |    -48% |   +131% |
| Softmax / dim=1000000x64 axi=-1                 |  22.09 |  16.63 |  51.84 |  11.57 |  27.27 |    +32% |    -47% |   +134% |
| Softmax / dim=64x16x32x1024 axi=-1              |  11.96 |   8.81 |  27.04 |   6.28 |  12.97 |    +35% |    -47% |   +126% |
| Softmax / dim=128x16x32x1024 axi=-1             |  23.39 |  17.23 |  54.22 |  12.38 |  27.82 |    +35% |    -47% |   +131% |
| Softmax / dim=1024x16x32x128 axi=-1             |  23.49 |  17.23 |  54.28 |  11.78 |  27.25 |    +36% |    -49% |   +131% |
| Softmax / dim=1024x64x32x8 axi=-1               |   6.20 |   4.60 |  13.49 |   3.70 |   9.51 |    +34% |    -40% |   +117% |
| Softplus / dim=128x16x1024                      |   0.41 |   0.41 |  13.78 |   0.39 |   2.02 |      0% |     -4% |  +3290% |
| Softplus / dim=64x128x1024                      |   1.07 |   1.06 |  53.84 |   1.03 |   8.03 |     +0% |     -3% |  +4927% |
| Sort / dim=64x128x1024 axi=0                    |   2.38 |   2.40 | 237.76 |  49.84 | 104.72 |      0% |  +1993% |  +9886% |
| Sort / dim=64x128x1024 axi=1                    |   2.40 |   2.40 | 237.75 |  45.56 |  90.17 |      0% |  +1801% |  +9822% |
| Sort / dim=64x128x1024 axi=2                    |   2.40 |   2.40 | 237.71 |  26.02 | 107.24 |      0% |   +985% |  +9819% |
| Sum / dim=64x128x128x128 axi=0                  |   5.69 |   5.71 |   8.85 |  15.83 |  29.19 |      0% |   +178% |    +55% |
| Sum / dim=64x128x128x128 axi=1                  |   5.69 |   5.70 |   8.50 |   6.27 |  26.30 |      0% |    +10% |    +49% |
| Sum / dim=64x128x128x128 axi=2                  |   5.69 |   5.70 |   8.53 |   6.10 |  10.78 |      0% |     +7% |    +50% |
| Sum / dim=64x128x128x128 axi=3                  |   5.68 |   5.70 |   8.66 |   5.84 |   8.50 |      0% |     +2% |    +52% |
| SumAll / dim=64x128x128x128                     |   5.69 |   5.69 |   8.50 |   6.14 |   8.15 |     +0% |     +7% |    +49% |
| SumAll / dim=1000000                            |   0.22 |   0.24 |   0.07 |   0.21 |   0.04 |     -5% |     -8% |    -69% |
| SumAll / dim=1000000x128                        |   5.44 |   5.46 |   8.11 |   5.89 |   7.79 |      0% |     +8% |    +49% |
| SumAll / dim=128x1000000                        |   5.44 |   5.46 |   8.13 |   5.86 |   7.77 |      0% |     +7% |    +49% |
